...
public class HighBrightnessFlashlightTileService extends TileService {
	...
	public void onClick() {
		...
		new Thread(() -> PXPreferences.putBoolean("HighBrightnessFlashlightEnabled", mLastEnabled)).start(); //otherwise click will be blocked until pref is saved
	}

	private void updateTile()
	{
		setTile(PXPreferences.getBoolean("HighBrightnessFlashlightEnabled", false));
	}
